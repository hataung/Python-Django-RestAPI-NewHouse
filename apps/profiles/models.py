...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default= "+31455491270")
    about_me = models.TextField(verbose_name=_("About me"), default="Say something about yourself")
    license = models.CharField(verbose_name=_("Realtor License"), max_length=20, blank=True, null=True)
    ...
    country = CountryField(verbose_name=_("Country"), default="NL",blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Amsterdam", blank=False, null=False)
