...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Amsterdam")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="140"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Leidseplein"
    )
    ...
    furnished = models.BooleanField(
        verbose_name=_("Furnished"), default=False
    )
    pool = models.BooleanField(
        verbose_name=_("Pool"), default=False
    )
    parking = models.BooleanField(
        verbose_name=_("Parking"), default=False
    )
    garden = models.BooleanField(
        verbose_name=_("Garden"), default=False
    )
    elevator = models.BooleanField(
        verbose_name=_("Elevator"), default=False
    )
    solar = models.BooleanField(
        verbose_name=_("Solar"), default=False
    )
